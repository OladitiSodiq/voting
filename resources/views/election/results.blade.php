...
<canvas id="treasurers" width="80%" class="Rcontainer"="20%" ></canvas>
<canvas id="spdirs" width="80%" class="Rcontainer"height="20%"></canvas>
<canvas id="sodirs" width="80%" class="Rcontainer" height="20%"></canvas>
<canvas id="pros" width="80%" class="Rcontainer" height="20%"></canvas>
<script>
...
var ctx = document.getElementById("treasurers");
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels:[
...
var ctx = document.getElementById("spdirs");
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels:[
...
var ctx = document.getElementById("sodirs");
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels:[
...
var ctx = document.getElementById("pros");
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels:[
